  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-main-bg p-4 font-sans">
      <div className="flex items-center mb-8">
        ...
        <span className="ml-3 text-3xl font-bold text-text-primary">AppLogo</span>
      </div>
      <Card className="w-full max-w-md" titleClassName="text-center text-xl" noPadding>
       ...
       <p className="mt-8 text-xs text-text-secondary text-center">
        © {new Date().getFullYear()} MA NU 01 Banyuputih. All rights reserved.
        <br />
        Gunakan username: <strong>admin</strong> dan password: <strong>admin123</strong> untuk demo.
      </p>
    </div>
  );
};
