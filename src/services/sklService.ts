...
import { getRomanMonth, getApiBaseUrl } from '@/lib/constants.ts';

// Refactor to move API_KEY and ai initialization inside generateSklContent to avoid process.env usage at top level
...
export const generateSklContent = async (student: Student): Promise<string> => {
  const API_KEY = "AIzaSyAsOImW9O15M5it_OKhhUB25suDFIpDmZY";
  if (!API_KEY) {
