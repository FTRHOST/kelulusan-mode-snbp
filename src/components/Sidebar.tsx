  ...
  return (
    ...
    >
      <div className="flex items-center h-20 border-b border-gray-200 px-4 shrink-0 justify-center lg:justify-start group-hover:justify-start">
         ...
         <img src={config.logo} alt="Logo Sekolah" className="h-8 w-8 text-brand-primary shrink-0" />
        <span className="ml-2 text-xl font-bold text-gray-800 whitespace-nowrap transition-all duration-200 opacity-0 w-0 overflow-hidden lg:opacity-100 lg:w-auto group-hover:opacity-100 group-hover:w-auto group-hover:delay-150">KELULUSAN</span>
      </div>
